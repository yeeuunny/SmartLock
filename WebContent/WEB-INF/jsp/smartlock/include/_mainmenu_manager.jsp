    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="/" data-toggle="tooltip" data-placement="bottom" title="홈">
            	<img src="/front/img/smartlock_logo.png" style="width: 160px; height:50px;"/>
	        </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li <%= (_nav != null && _nav.equals("manual")) ? "class=\"active\"" : "" %> data-toggle="tooltip" data-placement="bottom" title="매뉴얼">
                    <a href="/manual">매뉴얼</a>
                </li>
                    ...
                    <div class="dropdown-menu" style="width: auto; white-space: nowrap;">
                        <div style="position: relative;">
                            ...
                            <div style="position: absolute; top: 16px; left: 16px; width: 64px;">
                                <img src="/front/img/profile.png" alt="profile" style="width: 64px; height: 64px;">
                            </div>
                        </div>
                    </div>
                </li>
